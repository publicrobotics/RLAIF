...
from isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet_revolute import mdp

from isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet_revolute.cabinet_env_cfg import (  # isort: skip
    FRAME_MARKER_SMALL_CFG,
    CabinetEnvCfg,
)

"""
These are the imports that are required for
the rby1a enviornment to work
"""
...
"""
These imports are for the required CFGs
"""
...
@configclass
class RBY1ACabinetRevoluteEnvCfg(CabinetEnvCfg):
    def __post_init__(self):
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            ...
            target_frames=[
                ...
                # here figure out the left grippers left finger name
                FrameTransformerCfg.FrameCfg(
                ...
                # here figure out the left gripper right finger name
                FrameTransformerCfg.FrameCfg(
        ...
        self.rewards.grasp_handle.params["asset_cfg"].joint_names = ["gripper_finger_l.*"]


@configclass
class RBY1ACabinetRevoluteEnvCfg_PLAY(RBY1ACabinetRevoluteEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
