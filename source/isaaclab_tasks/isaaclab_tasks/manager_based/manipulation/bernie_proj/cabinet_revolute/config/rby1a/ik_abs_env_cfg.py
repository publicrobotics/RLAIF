...
from isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet_revolute.config.rby1a import joint_pos_env_cfg
...
@configclass
class RBY1ACabinetRevoluteEnvCfg(joint_pos_env_cfg.RBY1ACabinetRevoluteEnvCfg):
