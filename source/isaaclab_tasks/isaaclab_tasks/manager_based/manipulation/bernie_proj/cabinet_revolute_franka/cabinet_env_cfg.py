...
from isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet_revolute_franka import mdp
...
class CabinetSceneCfg(InteractiveSceneCfg):
    ...
    cabinet = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="/home/davin123/PoliGen/assets/cabinet_revolute.usd",
            activate_contact_sensors=False,
        ),
        init_state=ArticulationCfg.InitialStateCfg(
            # potentially change the x position of the cabinet
            pos=(0.95, 0.1, 0.6),
            rot=(0.0, 0.0, 0.0, 1.0),
            joint_pos={
                "door_left_joint": 0.0,
    ...
    cabinet_frame = FrameTransformerCfg(
        ...
        target_frames=[
            FrameTransformerCfg.FrameCfg(
                prim_path="{ENV_REGEX_NS}/Cabinet/left_door_handle",
...
class EventCfg:
    ...
    cabinet_physics_material = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("cabinet", body_names="left_door_handle"),
...
class RewardsCfg:
    ...
    # 2. Grasp the handle
    approach_gripper_handle = RewTerm(func=mdp.approach_gripper_handle, weight=25.0, params={"offset": MISSING})
    align_grasp_around_handle = RewTerm(func=mdp.align_grasp_around_handle, weight=0.15)
    ...
    open_drawer_bonus = RewTerm(
        func=mdp.open_revolute_bonus,
        weight=2.0,
        params={"asset_cfg": SceneEntityCfg("cabinet", joint_names=["door_left_joint"])},
    )
    multi_stage_open_drawer = RewTerm(
        func=mdp.multi_stage_open_revolute,
        weight=1.0,
        params={"asset_cfg": SceneEntityCfg("cabinet", joint_names=["door_left_joint"])},
    )
