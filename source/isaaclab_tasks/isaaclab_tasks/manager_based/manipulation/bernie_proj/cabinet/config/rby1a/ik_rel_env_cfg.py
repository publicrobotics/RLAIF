...
from isaaclab_tasks.isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet.config.rby1a import joint_pos_env_cfg
...
@configclass
class RBY1ACabinetEnvCfg(joint_pos_env_cfg.RBY1ACabinetEnvCfg):
