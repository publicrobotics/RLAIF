...
from isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet import mdp

from isaaclab_tasks.manager_based.manipulation.bernie_proj.cabinet.cabinet_env_cfg import (  # isort: skip
...
@configclass
class RBY1ACabinetEnvCfg(CabinetEnvCfg):
...
@configclass
class RBY1ACabinetEnvCfg_PLAY(RBY1ACabinetEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
